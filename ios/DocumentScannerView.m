...
- (void) capture {
    [self captureImageWithCompletionHander:^(UIImage *croppedImage, UIImage *initialImage, CIRectangleFeature *rectangleFeature) {
      if (self.onPictureTaken) {
            ...
            NSData *initialImageData = UIImagePNGRepresentation(initialImage);
            ...
            if (self.useBase64) {
              self.onPictureTaken(@{
               ...
               NSString *initialFilePath = [dir stringByAppendingPathComponent:[NSString stringWithFormat:@"initial_img_%i.png",(int)[NSDate date].timeIntervalSince1970]];
